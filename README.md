...
[![npm](https://img.shields.io/npm/v/react-native-template-brksreginaldo-advanced.svg?label=npm%20package)](https://www.npmjs.com/package/react-native-template-brksreginaldo-advanced)
[![npm](https://img.shields.io/npm/dt/react-native-template-brksreginaldo-advanced.svg)](https://www.npmjs.com/package/react-native-template-brksreginaldo-advanced)
[![GitHub issues](https://img.shields.io/github/issues-raw/BRKsReginaldo/react-native-template-brksreginaldo-advanced.svg)](https://github.com/BRKsReginaldo/react-native-template-brksreginaldo-advanced/issues)
[![GitHub last commit](https://img.shields.io/github/last-commit/BRKsReginaldo/react-native-template-brksreginaldo-advanced.svg)](https://github.com/BRKsReginaldo/react-native-template-brksreginaldo-advanced/commits/master)
[![NPM](https://img.shields.io/npm/l/react-native-template-brksreginaldo-advanced.svg)](https://choosealicense.com/licenses/mit)

<!-- PROJECT LOGO -->
<br />
<p align="center">
  <h3 align="center">Template BRKsReginaldo Advanced</h3>
</p>
...
- [Redux](https://redux.js.org/) - O Redux é um contêiner de estado previsível para aplicativos JavaScript. Ele ajuda você a escrever aplicativos que se comportam consistentemente, executados em diferentes ambientes (cliente, servidor e nativo) e são fáceis de testar;
  - [Redux Thunk](https://github.com/reduxjs/redux-thunk) - O redux-thunk é um middleware que permite criar e dispachar ações assincronas pro seu redux.
...
[Ambiente React Native (Android/iOS)](https://github.com/BRKsReginaldo/ambiente-react-native)
...
```sh
react-native init AwesomeExample --template brksreginaldo-advanced
```
...
BRKsReginaldo - [Github](https://github.com/BRKsReginaldo) - **reginaldo.junior696@gmail.com**
